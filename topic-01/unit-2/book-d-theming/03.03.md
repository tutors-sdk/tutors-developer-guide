...
You should have your CSS on the clipboard. It should look something like this:
...
export const myCustomTheme: CustomThemeConfig = {
    ...
    properties: {
		...
		// =~= Theme Colors  =~=
		// primary | #45d3a4 
		"--color-primary-50": "227 248 241", // #e3f8f1
		"--color-primary-100": "218 246 237", // #daf6ed
		"--color-primary-200": "209 244 232", // #d1f4e8
		"--color-primary-300": "181 237 219", // #b5eddb
		"--color-primary-400": "125 224 191", // #7de0bf
		"--color-primary-500": "69 211 164", // #45d3a4
		"--color-primary-600": "62 190 148", // #3ebe94
		"--color-primary-700": "52 158 123", // #349e7b
		"--color-primary-800": "41 127 98", // #297f62
		"--color-primary-900": "34 103 80", // #226750
		// secondary | #4F46E5 
